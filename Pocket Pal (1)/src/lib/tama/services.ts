...
export const petSignalService = {
  buildSignal(reason: "quiet_spark" | "return_after_absence", petName = "pocket", userName = "sam"): PetSignal {
  ...
  translateForFriend(_signal: PetSignal, userName = "sam") {
    return `${userName.toLowerCase()}'s been a bit quiet. maybe say hi?`;
  },
};
